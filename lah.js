...
<head>
   <title> Docs - Rulzz API </title>
   <meta name="viewport" content="width=device-width, initial-scale=1">
   <meta name="theme-color" content="#1C2333" />
   <meta name="keywords" content="restapi,webapi,rapidapi,deepai,chatgpt,whatapp,wabot,waifu,domain,minggu,anime">
   <meta name="description" content="Free rest Api's without login">
   <link href="https://apiruulzz.my.id" rel="canonical" />
   <meta property="og:url" content="https://apiruulzz.my.id" />
   <meta property="og:image" content="images/icon.png" />
   <meta property="og:image:secure_url" content="images/icon.png" />
   <meta property="og:image:type" content="image/jpeg" />
   <meta property="og:image:width" content="500" />
   <meta property="og:image:height" content="500" />
   <meta property="og:image:alt" content="Rulzz API" />
                 ...
                 <div class="container">
                    <header>
                       <table class="navigator">
                          <th>
                             <h1><a href="/" title="Docs - Rulzz API"><span id="header">Rulzz Api</span></a></h1>
            </th>
            <th>
               <a href="#" title="authkey"><button class="btn-primary">Endpoint</button></a>
            </th>
   ...
   <div class="col-6_sm-12">
      <div class="boxed">
        ...
        c0-4.465-3.62-8.084-8.084-8.084H261.164z" />
            ...
            <td>
               <h1>Visitor</h1><span class="count" id="visits"></span><br><span class="last-data" id="updatedAtt"></span>
            </td>
         </table>
      </div>
   </div>
...
<div class="grid">
   <div class="col-7_sm-12">
    ...
    <td class="ellipsis">Tiktok Download</td>
    <td align="center">

       <a href="/api/tiktok?url=https://vt.tiktok.com/ZSFsAecjF/"><button>Get</button></a></a>
    </td>
 </tr>
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Binjie AI</td>
    <td align="center">

       <a href="/api/binjie?query=hallo"><button>Get</button></a></a>
    </td>
 </tr>	    
<tr>
    <td><div class="circle pulse color-on"></div></td>
...
<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Herc.ai</td>
    <td align="center">

       <a href="/api/hercai?query=hallo"><button>Get</button></a></a>
    </td>
 </tr>		   
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Herc.ai (Image)</td>
    <td align="center">

       <a href="/api/hercaimg?prompt=cat"><button>Get</button></a></a>
    </td>
 </tr>	    
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Sight Ai</td>
    <td align="center">

       <a href="/api/sightai?url="><button>Get</button></a></a>
    </td>
 </tr>	    
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Ragbot Ai</td>
    <td align="center">

       <a href="/api/ragbot?query=hai"><button>Get</button></a></a>
    </td>
 </tr>	
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">DegreeGuru Ai</td>
    <td align="center">

       <a href="/api/degreeGuru?query=hai"><button>Get</button></a></a>
    </td>
 </tr>	 
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Pinecone Ai</td>
    <td align="center">

       <a href="/api/pinecone?query=hai"><button>Get</button></a></a>
    </td>
 </tr>	
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Smart Contract Ai</td>
    <td align="center">

       <a href="/api/smartContract?query=hai"><button>Get</button></a></a>
    </td>
 </tr>
<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Blackbox Ai</td>
    <td align="center">

       <a href="/api/blackbox?query=siapakah%20jokowi"><button>Get</button></a></a>
    </td>
 </tr>
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    ...
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">CAI Search Model</td>
    <td align="center">

       <a href="/api/search-character?query=hutao"><button>Get</button></a></a>
    </td>
 </tr>			
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">CAI Info Chara</td>
    <td align="center">

       <a href="/api/info-character?query=3Lln4tP_SbI46QrFwvs4Y4GhqgZTIwPASYCxfPykeRA"><button>Get</button></a></a>
    </td>
 </tr>	
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">CAI Send Message</td>
    <td align="center">

       <a href="/api/characterai?query=halo&id=3Lln4tP_SbI46QrFwvs4Y4GhqgZTIwPASYCxfPykeRA"><button>Get</button></a></a>
    </td>
 </tr>	
	<tr>
    <td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Aio Downloader</td>
    <td align="center">

       <a href="/api/aio?url=https://vt.tiktok.com/ZSFtNWv2f/"><button>Get</button></a></a>
    </td>
 </tr>	
	<tr>
    <td><div class="circle pulse color-on"></div></td>
...
<tr>
	...
	<td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Tiktok Stalk</td>
    <td align="center">

       <a href="/api/tiktokStalk?query=rtumona"><button>Get</button></a></a>
    </td>
 </tr>	
	</tr>
	<td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Spotify Download</td>
    <td align="center">

       <a href="/api/spotify?url=https://open.spotify.com/track/0RA9tn9qcAUJm9HOIKgvqQ?si=o2jCrIk6RUSjeTorIaw9_A"><button>Get</button></a></a>
    </td>
 </tr>		
	</tr>
	<td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Bard Ai</td>
    <td align="center">

       <a href="/api/bard?query=hi"><button>Get</button></a></a>
    </td>
 </tr>	
	</tr>
	<td><div class="circle pulse color-on"></div></td>
	...
	<td><div class="circle pulse color-on"></div></td>
    <td class="ellipsis">Capcut Download</td>
    <td align="center">

       <a href="/api/capcut?url=https://www.capcut.com/t/Zs8M85fpU/"><button>Get</button></a></a>
    </td>
 </tr>			    
	    </table>
	 </div>
...
<ul class="cloud" role="navigation" aria-label="Webdev tag cloud">
   <li><a href="https://saweria.co/RullZY">Donate</a></li>
   <li><a onclick="openFullscreen()">Change Screen</a></li>
   <li><a onclick="tos()">Chat Box</a></li>
         ...
         <div class="boxed pd-10 center">
            <footer>Developed By <a href="https://rulzz.my.id" style="color:crimson;">rulsnpai</a></footer>
         </div>
      </div>
   </div>
</div>
...
xhr.open("GET", "https://visitor-counter.kentodlahh11.workers.dev/visit?url=apiruulzz.my.id");
xhr.responseType = "json";
xhr.onload = function() {
    document.getElementById('visits').innerHTML = `<b>${this.response.today} / ${this.response.total}</b>`;
...
function Feat() {
 ...
 <tr>
    ...
    <td align="center">
       ...
       <a href="${c.endpoint}"><button>Get</button></a></a>
    </td>
 </tr>
                    `;
            ...
            loader.style.display = "none";
                ...
                function replaceHttpWithLink(value) {
                    if (typeof value === "string" && (value.includes("http://") || value.includes("https://"))) {
                        return `<a href=${value} style="color: crimson !important">${value}</a>`;
                    }
                    return value;
                }
...
document.addEventListener("DOMContentLoaded", function() {
  Swal.fire({
  title: "Tetot",
  text: "Jangan Lupa Join Saluran Whatsapp Kami Untuk Melihat Update Fitur Terbaru..",
  icon: "warning",
  showCancelButton: true,
  confirmButtonColor: "#0bd923",
  cancelButtonColor: "#0bd9d5",
  cancelButtonText: "Skip",
  confirmButtonText: "Ok",
  color: "#716add",
  backdrop: `
    rgba(0,0,123,0.4)
    url("https://telegra.ph/file/e8e9db3757fbb42f83913.jpg")
    bottom
    no-repeat
  `,
showClass: {
