...
async function yetedl3(url) {
try {
let txt = await youtubedlv2(url)
let dn = await txt.audio["128kbps"].download()
return {
id: txt.id,
title: txt.title,
thumbnail: txt.thumbnail,
audio: dn,
quality: "128kbps"
}
} catch (error) {
...
async function yetedl4(url) {
try {
let txt = await youtubedlv2(url)
let dn = await txt.video["360p"].download()
return {
id: txt.id,
title: txt.title,
thumbnail: txt.thumbnail,
